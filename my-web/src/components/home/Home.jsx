    ...
    <div className="home" id="home">
      <div className="wrapper">
        <motion.div
          ...
          animate="animate"
        >
          <motion.h2 variants={textVariants} data-text="Trần Nhật Linh">
            Trần Nhật Linh
            <svg
              width="36"
              height="36"
          ...
          <h3 className="home__subtitle" data-text="Say Hello">
            Say Hello
          </h3>
          <motion.h1 variants={textVariants}>
            Web developer and UI design
          </motion.h1>
          <motion.div className="buttons" variants={textVariants}>
            <motion.button className="primary" variants={textVariants}>
              <a href="#portfolio">See the Latest Works</a>
            </motion.button>
            <motion.button className="secondary" variants={textVariants}>
      ...
      <motion.div
        ...
        animate="animate"
      >
        Creator of convenient and safe websites
      </motion.div>
